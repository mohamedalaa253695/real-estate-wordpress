...
class Realia_Customizations_General {
	...
	public static function customizations( $wp_customize ) {
		...
		// Location filter field type
		$wp_customize->add_setting( 'realia_filter_location_field_type', array(
			'default'           => 'single-select',
			'capability'        => 'edit_theme_options',
			'sanitize_callback' => 'sanitize_text_field',
		) );

		$wp_customize->add_control( 'realia_filter_location_field_type', array(
			'type'      => 'select',
			'label'     => __( 'Location filter field type', 'realia' ),
			'section'   => 'realia_general',
			'settings'  => 'realia_filter_location_field_type',
			'choices'	=> array(
				'single-select'	=> __( 'single select', 'realia'),
				'chain-select'	=> __( 'chain select', 'realia'),
			)
		) );
