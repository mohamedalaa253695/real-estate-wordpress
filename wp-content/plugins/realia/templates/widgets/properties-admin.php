...
<p>
    <label for="<?php echo esc_attr( $this->get_field_id( 'orderby' ) ); ?>">
        <?php echo __( 'Order by', 'realia' ); ?>
    </label>

    <select id="<?php echo esc_attr( $this->get_field_id( 'orderby' ) ); ?>"
            name="<?php echo esc_attr( $this->get_field_name( 'orderby' ) ); ?>">
        <option value="date" <?php echo ( 'date' == $orderby || empty( $orderby ) ) ? 'selected="selected"' : ''; ?>><?php echo __( 'Date', 'realia' ); ?></option>
        <option value="rand" <?php echo ( 'rand' == $orderby ) ? 'selected="selected"' : ''; ?>><?php echo __( 'Random', 'realia' ); ?></option>
    </select>
</p>
