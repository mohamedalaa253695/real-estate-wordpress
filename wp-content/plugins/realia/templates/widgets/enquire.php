...
<form method="post" action="<?php the_permalink(); ?>">
    ...
    <div class="form-group">
        <input class="form-control" name="name" type="text" placeholder="<?php echo __( 'Name', 'realia' ); ?>" value="<?php echo empty( $_POST['name'] ) ? '' : esc_attr( $_POST['name'] ); ?>" required="required">
    </div><!-- /.form-group -->
    ...
    <div class="form-group">
        <input class="form-control" name="phone" type="text" placeholder="<?php echo __( 'Phone', 'realia' ); ?>" value="<?php echo empty( $_POST['phone'] ) ? '' : esc_attr( $_POST['phone'] ); ?>" required="required">
    </div><!-- /.form-group -->
