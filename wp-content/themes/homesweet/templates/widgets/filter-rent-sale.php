...
<div class="tabs <?php echo esc_attr( $classes );?>">
	<ul class="tabs-navigation clearfix">
		...
		<li class="rent <?php if ( empty( $_GET['filter-contract'] ) || 'RENT' == $_GET['filter-contract'] ) : ?>active<?php endif; ?>"><a href="#<?php echo esc_attr( $args['widget_id'] ); ?>-rent"><?php echo esc_html__( 'For Rent', 'homesweet' ); ?></a></li>
		<li class="sale <?php if ( ! empty( $_GET['filter-contract'] ) && 'SALE' == $_GET['filter-contract'] ) : ?>active<?php endif; ?>"><a href="#<?php echo esc_attr( $args['widget_id'] ); ?>-sale"><?php echo esc_html__( 'For Sale', 'homesweet' ); ?></a></li>
