<div class="form-group group-select">
	<?php if ( 'labels' == $input_titles ) : ?>
		<label for="<?php echo ! empty( $field_id_prefix ) ? $field_id_prefix : ''; ?><?php echo esc_attr( $args['widget_id'] ); ?>_baths"><?php echo esc_html__( 'Baths', 'homesweet' ); ?></label>
	<?php endif; ?>
	...
	<select name="filter-baths"
		...
		<option value="">
			<?php if ( 'placeholders' == $input_titles ) : ?>
				<?php echo esc_html__( 'Baths: any', 'homesweet' ); ?>
			<?php else : ?>
