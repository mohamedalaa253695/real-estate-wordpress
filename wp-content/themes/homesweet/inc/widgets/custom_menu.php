...
class Homesweet_Custom_Menu extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_custom_menu',
            esc_html__('Apus Custom Menu Widget', 'homesweet'),
            array( 'description' => esc_html__( 'Show custom menu', 'homesweet' ), )
        );
...
register_widget( 'Homesweet_Custom_Menu' );