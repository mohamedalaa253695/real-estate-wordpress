...
class Homesweet_Recent_Comment extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_recent_comment',
            esc_html__('Apus Recent Comments Widget', 'homesweet'),
            array( 'description' => esc_html__( 'Show list of recent comments', 'homesweet' ), )
        );
    ...
    public function form( $instance ) {
        if ( isset( $instance[ 'title' ] ) ) {
            ...
            $title = esc_html__( 'Latest Post', 'homesweet' );
        }
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'number_comment' )); ?>"><?php esc_html_e( 'Num Comments:', 'homesweet' ); ?></label>
...
register_widget( 'Homesweet_Recent_Comment' );