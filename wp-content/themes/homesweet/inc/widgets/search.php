...
class Homesweet_Search extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_search',
            esc_html__('Apus Search Widget', 'homesweet'),
            array( 'description' => esc_html__( 'Show search form in sidebar', 'homesweet' ), )
        );
...
register_widget( 'Homesweet_Search' );