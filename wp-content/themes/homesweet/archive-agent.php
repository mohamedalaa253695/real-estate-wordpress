...
get_header();
$sidebar_configs = homesweet_get_agent_layout_configs();
?>
...
<section id="main-container" class="main-content <?php echo apply_filters('homesweet_agent_content_class', 'container');?> inner">
    <div class="row">
